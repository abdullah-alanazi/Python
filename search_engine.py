...
while(loo >0):
    ...
    if len(q1) > 0:
        ...
        print("\033[35;7mYOU HAVE ENTER QUEry\033[0m\n ")
print( "\n", op , "\033[34;4msearch for:\033[0m", q1, "\n")
x = 0
for h,qt in enumerate(data_list):
    A = "yes"
    w = qt.split()
    for q2 in q1:
        if (op == "_OR_"):
            A = "no"
            if(q2 in w):
                print("\033[35;7m:::FOUND AT:::\033[0m", h, qt[0:1000],"\n")
                x = x+ 1
                break
        else:
            if (q2 not in w ):
    ...
    if (A == "yes"):
        ...
        x = x+1
if (x == 0):
    print ("\033[31;1mNo Matching.\033[0m\n")
else:
    print (x, "\033[31;1mMatching.\033[0m\n")
